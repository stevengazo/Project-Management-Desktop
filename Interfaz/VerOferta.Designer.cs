namespace Interfaz
{
	partial class VerOferta
	{
		...
		private void InitializeComponent()
		{
			...
			this.txtCotizador = new System.Windows.Forms.TextBox();
			...
			// groupBox1
			// 
			this.groupBox1.Controls.Add(this.textEncargado);
			this.groupBox1.Controls.Add(this.txtFecha);
			this.groupBox1.Controls.Add(this.label12);
			this.groupBox1.Controls.Add(this.txtCotizador);
			...
			// textEncargado
			// 
			this.textEncargado.Location = new System.Drawing.Point(103, 368);
			this.textEncargado.Name = "textEncargado";
			this.textEncargado.PlaceholderText = "Adrian ";
			this.textEncargado.ReadOnly = true;
			this.textEncargado.Size = new System.Drawing.Size(184, 23);
			this.textEncargado.TabIndex = 28;
			this.textEncargado.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
			// 
			// txtFecha
			// 
			this.txtFecha.Location = new System.Drawing.Point(103, 22);
			this.txtFecha.Name = "txtFecha";
			this.txtFecha.PlaceholderText = "Pepe";
			...
			// txtCotizador
			// 
			this.txtCotizador.Location = new System.Drawing.Point(103, 397);
			this.txtCotizador.Name = "txtCotizador";
			this.txtCotizador.PlaceholderText = "Adrian ";
			this.txtCotizador.ReadOnly = true;
			this.txtCotizador.Size = new System.Drawing.Size(184, 23);
			this.txtCotizador.TabIndex = 25;
			this.txtCotizador.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
			// 
			// label11
			// 
			...
			this.txtObservaciones.RightToLeft = System.Windows.Forms.RightToLeft.Yes;
			...
			this.txtNotas.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
			// 
			// label7
			// 
			...
			this.Text = "VerOferta";
			this.Load += new System.EventHandler(this.VerOferta_Load);
